  ...
  <div class="container">
    ...
    <div class="accordion accordion-flush" id="questions">
      ...
      <div class="accordion-item">
        ...
        >
          <div class="accordion-body">
            You may donate up to 9,000,000,000. After that the bank gets suspicious!
          </div>
        </div>
      </div>
      <div class="accordion-item">
        <h2 class="accordion-header" id="flush-headingThree">
          ...
          >
            Can I donate to multiple charity's?
          </button>
        </h2>
        <div
        ...
        >
          <div class="accordion-body">
            Yes! You will have to do so in separate transactions but you  can spread your donations to as many charities as you would like.
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="modal-body">
        ...
        <form action="#">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="first-name">
                <label for="first-email" class="col-form-label">First Email:</label>
                <input type="text" class="form-control" id="first-name">
