...
<html lang="en">
  ...
  <body>
    ...
    <button id="test">The Button</button>
        ...
        <img id="road-map" class="img-fluid w-25 mt-5"src="./assets/img/register.svg" alt="Registration Form">
        </div>
      </div>
 </section>
    ...
    <div class="accordion accordion-flush" id="questions">
      <div class="accordion-item">
        <h2 class="accordion-header" id="flush-headingOne">
          ...
          >
            Will you sell my information for personal gain?
          </button>
        </h2>
        <div
      ...
      <div class="accordion-item">
        <h2 class="accordion-header" id="flush-headingTwo">
          ...
          >
            How does the money from the race get to the charity?
          </button>
        </h2>
        <div
        ...
        >
          <div class="accordion-body">
            We never see any of the funds. All funds are sent directly to the charity you  are running for!
          </div>
        </div>
      </div>
      <div class="accordion-item">
        ...
        >
          <div class="accordion-body">
            Yes! You may also go to our donations page and leave a "tip" for your charity!
          </div>
        </div>
      </div>
    </div>
